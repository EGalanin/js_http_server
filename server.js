...
const secondTicket = new Tickets(uuid.v4(), 'установить обновление KB-1245', 'Пришло критическое обновление для Windows, нужно поставить обновление в следующем приоритете:\n 1. Сервера (незабыть сделать бэкап!)\n 2. Рабочие станции', false, new Date());
